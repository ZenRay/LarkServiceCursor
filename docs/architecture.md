...
└─────────────────────────────────────────────────────────────┘
                            ...
                            ▼
┌─────────────────────────────────────────────────────────────┐
│               数据模型层 (models/) - SQLAlchemy 2.0          │
│  • Application (SQLite)  - ConfigBase                        │
│  • TokenStorage (PostgreSQL) - Base                          │
│  • UserCache (PostgreSQL) - Base                             │
│  • AuthSession (PostgreSQL) - Base                           │
│  ✅ 使用 DeclarativeBase + Mapped[T] 类型注解                │
│  ✅ 100% Mypy 类型安全 (0 个错误)                            │
└─────────────────────────────────────────────────────────────┘
```
